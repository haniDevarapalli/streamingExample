...
int main()
{
    ...
    ViInt32 triggerSlope = AQMD3_VAL_TRIGGER_SLOPE_POSITIVE;
    ...
    cout << "Active Source: " << triggerSource << "\n";
    cout << "Trigger Level: " << triggerLevel << "\n";
    cout << "Trigger Slope: " << (triggerSlope ==AQMD3_VAL_TRIGGER_SLOPE_POSITIVE ? "Positive" : "Negative" ) << "\n\n";
    ...
    vector<ViInt32> dataArray( static_cast<size_t>(arraySize) );
    ...
    for( ViInt64 currentRecord=0 ; currentRecord<actualRecords ; ++currentRecord )
    {
        ...
        {
            ViInt32 const valueRaw = dataArray[static_cast<size_t>(firstValidPoint[currentRecord]+currentPoint)];
