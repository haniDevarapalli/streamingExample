...
int main()
{
    ...
    checkApiCall( AqMD3_FetchMultiRecordWaveformInt16( session, "Channel1", 0, numRecords, 0, recordSize, arraySize,
    ...
    for( ViInt64 currentRecord = 0; currentRecord<numRecords; ++currentRecord )
    {
        ...
        {
            ViReal64 valueInVolts = dataArray[static_cast<size_t>(firstValidPoint[currentRecord]+currentPoint)]*scaleFactor + scaleOffset;
        }
    }
