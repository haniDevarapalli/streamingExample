...
#define AQMD3_ATTR_PRIVATE_STORE_COMPATIBLE_WITH            (IVI_SPECIFIC_ATTR_BASE + 150L)  /* ViString, read-write */
...
#define AQMD3_ATTR_EEPROM_MODULE_GENERATION_TESTED_DRIVER_VERSION  (IVI_SPECIFIC_ATTR_BASE + 162L)  /* ViString, read-write */
#define AQMD3_ATTR_EEPROM_MODULE_GENERATION_MAXIMUM_DRIVER_VERSION (IVI_SPECIFIC_ATTR_BASE + 163L)  /* ViString, read-write */
...
#define AQMD3_ATTR_CHANNEL_SAMPLING_DELAY                   (IVI_SPECIFIC_ATTR_BASE + 171L)  /* ViReal64, read-write */
...
#define AQMD3_ATTR_CHANNEL_PEAK_LIST_VALUE_SMOOTHING_LENGTH             (IVI_SPECIFIC_ATTR_BASE + 141L)  /* ViInt32, read-write */
#define AQMD3_ATTR_CHANNEL_PEAK_LIST_DERIVATIVE_SMOOTHING_LENGTH        (IVI_SPECIFIC_ATTR_BASE + 142L)  /* ViInt32, read-write */
#define AQMD3_ATTR_CHANNEL_PEAK_LIST_PULSE_VALUE_THRESHOLD              (IVI_SPECIFIC_ATTR_BASE + 143L)  /* ViInt32, read-write */
#define AQMD3_ATTR_CHANNEL_PEAK_LIST_PULSE_DERIVATIVE_THRESHOLD_RISING  (IVI_SPECIFIC_ATTR_BASE + 144L)  /* ViInt32, read-write */
#define AQMD3_ATTR_CHANNEL_PEAK_LIST_PULSE_DERIVATIVE_THRESHOLD_FALLING (IVI_SPECIFIC_ATTR_BASE + 145L)  /* ViInt32, read-write */
#define AQMD3_ATTR_CHANNEL_PEAK_LIST_PULSE_DERIVATIVE_HYSTERESIS        (IVI_SPECIFIC_ATTR_BASE + 146L)  /* ViInt32, read-write */
#define AQMD3_ATTR_CHANNEL_PEAK_LIST_BASELINE                           (IVI_SPECIFIC_ATTR_BASE + 147L)  /* ViInt32, read-write */
#define AQMD3_ATTR_CHANNEL_PEAK_LIST_DATA_STORAGE_MODE                  (IVI_SPECIFIC_ATTR_BASE + 148L)  /* ViInt32, read-write */
#define AQMD3_ATTR_CHANNEL_PEAK_LIST_DESCRIPTOR_FORMAT                  (IVI_SPECIFIC_ATTR_BASE + 164L)  /* ViInt32, read-write */
#define AQMD3_ATTR_CHANNEL_PEAK_LIST_OBSERVATION_WINDOW_DELAY           (IVI_SPECIFIC_ATTR_BASE + 165L)  /* ViInt64, read-write */
#define AQMD3_ATTR_CHANNEL_PEAK_LIST_OBSERVATION_WINDOW_WIDTH           (IVI_SPECIFIC_ATTR_BASE + 166L)  /* ViInt64, read-write */
#define AQMD3_ATTR_CHANNEL_PEAK_LIST_OBSERVATION_WINDOW_ENABLED         (IVI_SPECIFIC_ATTR_BASE + 167L)  /* ViBoolean, read-write */
#define AQMD3_ATTR_CHANNEL_PEAK_LIST_OBSERVATION_WINDOW_GRANULARITY     (IVI_SPECIFIC_ATTR_BASE + 168L)  /* ViInt64, read-only */

/*- Filter */

#define AQMD3_ATTR_INPUT_FILTER_BYPASS_ANTI_ALIASING        (IVI_SPECIFIC_ATTR_BASE + 153L)  /* ViBoolean, read-write */
#define AQMD3_ATTR_INPUT_FILTER_BYPASS_MOVING_AVERAGE       (IVI_SPECIFIC_ATTR_BASE + 170L)  /* ViBoolean, read-write */
...
#define AQMD3_ATTR_CALIBRATION_INTER_CHANNEL_DELAY_ENABLED  (IVI_SPECIFIC_ATTR_BASE + 172L)  /* ViBoolean, read-write */
...
#define AQMD3_ATTR_CONTROL_IO_OUT_SOFTWARE_STATE            (IVI_SPECIFIC_ATTR_BASE + 151L)  /* ViInt32, read-write */
#define AQMD3_ATTR_CONTROL_IO_IN_SOFTWARE_STATE             (IVI_SPECIFIC_ATTR_BASE + 152L)  /* ViInt32, read-only */
#define AQMD3_ATTR_CONTROL_IO_INPUT_TERMINATION             (IVI_SPECIFIC_ATTR_BASE + 169L)  /* ViInt32, read-write */
...
#define AQMD3_ATTR_DIGITAL_OUT_START_SOURCE                 (IVI_SPECIFIC_ATTR_BASE + 154L)  /* ViString, read-write */

/*- Output */

#define AQMD3_ATTR_DIGITAL_OUTPUT_COUNT                     (IVI_SPECIFIC_ATTR_BASE + 155L)  /* ViInt32, read-only */
#define AQMD3_ATTR_DIGITAL_OUTPUT_NUMBER_OF_PULSES          (IVI_SPECIFIC_ATTR_BASE + 156L)  /* ViInt32, read-write */
#define AQMD3_ATTR_DIGITAL_OUTPUT_PULSE_PERIOD              (IVI_SPECIFIC_ATTR_BASE + 157L)  /* ViReal64, read-write */
#define AQMD3_ATTR_DIGITAL_OUTPUT_PULSE_WIDTH               (IVI_SPECIFIC_ATTR_BASE + 158L)  /* ViReal64, read-write */
#define AQMD3_ATTR_DIGITAL_OUTPUT_PULSE_DELAY               (IVI_SPECIFIC_ATTR_BASE + 159L)  /* ViReal64, read-write */
#define AQMD3_ATTR_DIGITAL_OUTPUT_PULSE_POLARITY            (IVI_SPECIFIC_ATTR_BASE + 160L)  /* ViInt32, read-write */
#define AQMD3_ATTR_DIGITAL_OUTPUT_MODE                      (IVI_SPECIFIC_ATTR_BASE + 161L)  /* ViInt32, read-write */
...
#define AQMD3_VAL_ACQUISITION_MODE_PEAK_LIST                5
...
#define AQMD3_VAL_STREAMING_MODE_TRIGGERED_COUNT            3
...
/*- Defined values for 
	attribute AQMD3_ATTR_CHANNEL_PEAK_LIST_DATA_STORAGE_MODE */

#define AQMD3_VAL_PEAK_LIST_DATA_STORAGE_MODE_NONE                0
#define AQMD3_VAL_PEAK_LIST_DATA_STORAGE_MODE_RAW                 1
#define AQMD3_VAL_PEAK_LIST_DATA_STORAGE_MODE_FILTERED            2
#define AQMD3_VAL_PEAK_LIST_DATA_STORAGE_MODE_FILTERED_DERIVATIVE 3

/*- Defined values for 
	attribute AQMD3_ATTR_CONTROL_IO_OUT_SOFTWARE_STATE
	attribute AQMD3_ATTR_CONTROL_IO_IN_SOFTWARE_STATE */

#define AQMD3_VAL_CONTROL_IO_STATE_LOW                      0
#define AQMD3_VAL_CONTROL_IO_STATE_HIGH                     1
#define AQMD3_VAL_CONTROL_IO_STATE_UNDETERMINED             2

/*- Defined values for 
	attribute AQMD3_ATTR_DIGITAL_OUTPUT_PULSE_POLARITY */

#define AQMD3_VAL_DIGITAL_OUTPUT_PULSE_POLARITY_NEGATIVE    0
#define AQMD3_VAL_DIGITAL_OUTPUT_PULSE_POLARITY_POSITIVE    1

/*- Defined values for 
	attribute AQMD3_ATTR_DIGITAL_OUTPUT_MODE */

#define AQMD3_VAL_DIGITAL_OUTPUT_MODE_DISABLED              0
#define AQMD3_VAL_DIGITAL_OUTPUT_MODE_LOW_LEVEL             1
#define AQMD3_VAL_DIGITAL_OUTPUT_MODE_HIGH_LEVEL            2
#define AQMD3_VAL_DIGITAL_OUTPUT_MODE_BURST                 3
#define AQMD3_VAL_DIGITAL_OUTPUT_MODE_PERIODIC              4

/*- Defined values for 
	attribute AQMD3_ATTR_CHANNEL_PEAK_LIST_DESCRIPTOR_FORMAT */

#define AQMD3_VAL_PEAK_LIST_DESCRIPTOR_FORMAT_EXTENDED       0
#define AQMD3_VAL_PEAK_LIST_DESCRIPTOR_FORMAT_PEAK           1
#define AQMD3_VAL_PEAK_LIST_DESCRIPTOR_FORMAT_CENTER_OF_MASS 2
#define AQMD3_VAL_PEAK_LIST_DESCRIPTOR_FORMAT_PEAK_AREA      3
#define AQMD3_VAL_PEAK_LIST_DESCRIPTOR_FORMAT_CUSTOM1        5

/*- Defined values for 
	attribute AQMD3_ATTR_CONTROL_IO_INPUT_TERMINATION */

#define AQMD3_VAL_CONTROL_IO_INPUT_TERMINATION_WEAK_PULL_UP 0
#define AQMD3_VAL_CONTROL_IO_INPUT_TERMINATION_PULL_DOWN    1
...
ViStatus _VI_FUNC AqMD3_DigitalOutInitiateGeneration(ViSession Vi);
ViStatus _VI_FUNC AqMD3_DigitalOutAbortGeneration(ViSession Vi);

/*- Output */

ViStatus _VI_FUNC AqMD3_GetDigitalOutputName(ViSession Vi, ViInt32 Index, ViInt32 NameBufferSize, ViChar Name[]);
...
#define AQMD3_ERROR_DEVICE_LOCKED                           (IVIC_SPECIFIC_ERROR_BASE + 0x000E)
