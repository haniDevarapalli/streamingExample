...
'
' Creates a driver object, reads a few Identity interface properties, and performs a multi-record
' acquisition.
'
...
Module VB_MultiRecordAcquisition
    Sub Main()
        Console.WriteLine("  VB_MultiRecordAcquisition")
        Console.WriteLine()
        ...
        Try
            ...
            driver.Channels.Item("Channel1").Configure(range, offset, coupling, True)
            Dim numRecords As Integer = 20
            Dim recordSize As Integer = 1000
            ...
            ' Fetch the acquired.
            Dim Waveforms As Ivi.Digitizer.IWaveformCollection(Of Int16) = Nothing
            ' Giving a NoThing as waveform to the fetch function means the driver will allocate the proper amount of memory during
            Waveforms = driver.Channels.Item("Channel1").MultiRecordMeasurement.FetchMultiRecordWaveform(0, numRecords, 0, recordSize, Waveforms)

            ' Convert data to Volts.
            Console.WriteLine("Processing data")
            For Each waveform In Waveforms
